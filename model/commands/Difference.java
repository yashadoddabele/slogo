...
/**
 * Difference Command Implementation.
 */
public class Difference implements Command {
   ...
   */
  public Difference(Turtle turtle, VariableController variableController,
  ...
  public double execute() {
    return executeSubCommandList(expr1) - executeSubCommandList(expr2);
  }
