...
/**
 * SetTowards Command Implementation.
 */
public class SetTowards implements Command {
   ...
   */
  public SetTowards(Turtle turtle, VariableController variableController,
  ...
  public double execute() {
    return turtle.rotateTowards(executeSubCommandList(expr1), executeSubCommandList(expr2));
  }
