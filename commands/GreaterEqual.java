...
/**
 * GreaterEqual Command Implementation.
 */
public class GreaterEqual implements Command {
   ...
   */
  public GreaterEqual(Turtle turtle, VariableController variableController,
  ...
  public double execute() {
    return executeSubCommandList(expr1) >= executeSubCommandList(expr2) ? 1 : 0;
  }
