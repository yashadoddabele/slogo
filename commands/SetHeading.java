...
/**
 * SetHeading Command Implementation.
 */
public class SetHeading implements Command {
   ...
   */
  public SetHeading(Turtle turtle, VariableController variableController,
  ...
  public double execute() {
    return turtle.setAngle(executeSubCommandList(angle));
  }
